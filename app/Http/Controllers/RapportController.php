        ...
        $data = Cache::remember($cacheKey, now()->addMinutes(10), function() use ($bilanSarQuery, $request, $dateFilter, $yearQuarter, $quarter, $yearMonth, $month, $filterYear, $start, $end) {
            ...
            $typesChartConfig = [
                ...
                'data'    => [
                    'labels'   => $typesLabels,
                    'datasets' => [[
                        'label'           => "Nombre d'événements (Types d'incidents)",
                        'data'            => $typesCounts,
            ...
            $causesChartConfig = [
                ...
                'data'    => [
                    'labels'   => $causesLabels,
                    'datasets' => [[
                        'label'           => "Nombre d'événements (Causes d'incidents)",
                        'data'            => $causesCounts,
                        'backgroundColor' => $colorsUsed,
                    ]]
                ],
            ...
            $flagChartConfig = [
                ...
                'options' => [
                    'responsive'          => false,      // pour prendre en compte explicitement la taille
                    'maintainAspectRatio'=> false,
                    'scales'             => [
                        // Chart.js v3/v4
                        'x' => [
                            'ticks' => [
                                'autoSkip'  => false,  // n'enlever aucun label
                                'maxRotation'=> 45,     // rotation max si beaucoup de labels
                                'minRotation'=> 0
                            ]
                        ],
                        'y' => [
            ...
            $flagChartConfig['options'] = [
                'responsive'           => false,
                'maintainAspectRatio'  => false,
                'scales' => [
                    'x' => [
                        'ticks' => [
                            'autoSkip'    => false,    // on veut tous les labels
                            'minRotation' => 45,       // angle d’inclinaison minimum
                            'maxRotation' => 45,       // angle d’inclinaison maximum
                            'align'       => 'start',  // commence au début de chaque tick
                            'padding'     => 5,
                            'font'        => [
                                'size' => 12         // réduit ou augmente selon vos besoins
                            ],
                        ],
                    ],
                    'y' => [
            ...
            $portChartConfig = [
                ...
                'data'    => [
                    'labels'   => $portLabels,
                    'datasets' => [[
                        'label'           => "Nombre de navire par Port",
                        'data'            => $portValues,
