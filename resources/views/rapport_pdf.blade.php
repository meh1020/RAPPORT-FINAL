            ...
            <div class="chart-desc">
                ...
                <ul>
                    @foreach($regionsData as $region)
                        <li>{{ $region['count'] }} incident{{ $region['count'] > 1 ? 's': ''}} dans la region {{ $region['name'] }}</li>
                    @endforeach
                </ul>
            </div>
        </div>
            ...
            <table class="table table-bordered table-hover table-striped">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th style="width: 20px">SURVIVANTS</th>
                        <th style="width: 20px">BLESSES</th>
                        <th style="width: 20px">MORTS</th>
                        <th style="width: 20px">DISPARUS</th>
                        <th style="width: 20px">EVASAN</th>
                    </tr>
                </thead>
                <tbody>
